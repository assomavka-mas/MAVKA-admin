  ...
  <section id="parcours" class="sand">
    <div class="wrap">
      <div class="head">
        ...
        <p class="lede">Un parcours progressif, pensé pour avancer sans engagement lourd dès le départ — chaque étape s'appuie sur les retours de la précédente.</p>
      </div>
