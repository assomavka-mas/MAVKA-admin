  ...
  <section id="steps">
    <div class="wrap">
      <div class="head">
        ...
        <h2>De la première rencontre à une activité qui vous ressemble</h2>
      ...
      <div class="steps">
        ...
        <div class="step"><h3>Engagement</h3><p>Si l'approche vous parle, vous pouvez rejoindre l'équipe comme bénévole et participer aux actions de MAVKA. Vos frais nécessaires peuvent être remboursés selon les règles de l'association.</p></div>
        <div class="step"><h3>Expérimentation</h3><p>Vous préparez et testez une première activité. Vous vérifiez le format, l'intérêt du public et ce qui fonctionne. Ensemble, nous décidons ensuite s'il est utile de poursuivre ou d'adapter l'activité.</p></div>
        <div class="step"><h3>Collaboration durable</h3><p>Si l'activité trouve son public, la collaboration peut continuer et évoluer : activité bénévole, projet plus structuré ou prestation professionnelle. Le cadre est défini selon la situation, les objectifs et les possibilités de chacun.</p></div>
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="wrap">
      <div class="cta-card">
        ...
        <p>Nous ne cherchons pas seulement des intervenants. Nous accueillons aussi des personnes qui souhaitent partager un savoir-faire, tester une idée ou développer progressivement un projet avec MAVKA.</p>
        <div class="actions">
  ...
  <section id="docs">
    <div class="wrap">
      ...
      <ul class="docs">
        ...
        <li><a href="https://docs.google.com/document/d/1LyGOTT19kAvVHCHUgAY6ut4QiwOpwdJTKR5rTZaH0zE/edit?usp=sharing" target="_blank" rel="noopener"><svg class="doc-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M6 2h9l5 5v15H6z"/><path d="M15 2v5h5"/></svg><span>Charte du bénévolat</span><span class="st">Doc</span></a></li>
        <li><a href="https://docs.google.com/document/d/1u0cvCNCnOfa3CI_OWb2FXYORGVuDYeFq2Gy52laZiwY/edit?usp=sharing" target="_blank" rel="noopener"><svg class="doc-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M6 2h9l5 5v15H6z"/><path d="M15 2v5h5"/></svg><span>Modèles de conventions et d'engagement</span><span class="st">Doc</span></a></li>
