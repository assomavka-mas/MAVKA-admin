    ...
    <div class="wrap split">
      ...
      <div>
        ...
        <ul class="list">
          ...
          <li><span><b>Parcours et reconversion.</b> Un cadre pour partager ses savoir-faire, expérimenter une activité et, pour ceux qui le souhaitent, explorer de nouvelles perspectives associatives ou professionnelles.</span></li>
        </ul>
      </div>
    </div>
  </section>
    ...
    <div class="wrap">
      ...
      <div class="steps cols-3">
        ...
        <div class="step">
          ...
          <ul class="list" style="margin-top:2px">
            <li><span>Identification des actions possibles, ensemble</span></li>
            <li><span>Adaptation des propositions au contexte local</span></li>
          </ul>
        </div>
        <div class="step">
          <h3>Phase pilote</h3>
          <ul class="list" style="margin-top:2px">
            <li><span>Un ou deux ateliers test, en petit groupe</span></li>
            <li><span>Évaluation conjointe avec la mairie et les participants</span></li>
          </ul>
        </div>
        <div class="step">
        ...
        <div class="step">
          ...
          <ul class="list" style="margin-top:2px">
            <li><span>Reprendre les formats qui ont bien fonctionné</span></li>
            <li><span>Élargir à de nouveaux participants, adapter la collaboration selon les besoins</span></li>
          </ul>
        </div>
        <div class="step">
