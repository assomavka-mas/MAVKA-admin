  ...
  <section class="agenda-teaser">
    <div class="wrap">
      <div class="head">
        ...
        <p class="lede">Les préinscriptions nous permettent de connaître les besoins, de constituer les groupes et d'organiser les activités dans les meilleures conditions.</p>
      </div>
