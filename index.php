  ...
  <section class="sand">
    <div class="wrap split">
      ...
      <div>
        ...
        <p class="lede">Chacun participe selon son rôle, ses disponibilités et le cadre de sa collaboration.</p>
      </div>
    </div>
  </section>
