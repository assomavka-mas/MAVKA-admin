...
// Nombre de projets personnels affichés publiquement (bloc "chiffres" de l'accueil) — un projet
// compte dès qu'il a un nom ou une description (voir intervenant-form.php, section "Suivi
// interne"), pas besoin d'une requête séparée puisque site_intervenants_actifs() renvoie déjà
// tous les champs.
$site_projets_count = count(array_filter($site_intervenants, fn($iv) =>
    !empty($iv['projet_developpement_nom']) || !empty($iv['projet_developpement_description'])));
...
<div class="page" id="page-accueil">
  ...
  <section>
    <div class="wrap dir-grid">
      ...
      <div class="dir-art"><img src="/assets/site-img/img-06-3bc40d08fc.webp?v=<?= @filemtime(__DIR__ . '/assets/site-img/img-06-3bc40d08fc.webp') ?: time() ?>" alt="Mavka assise, en train de lire"></div>
    </div>
  </section>
...
<div class="page" id="page-agenda">
  ...
  <section class="sand">
    <div class="wrap split">
      ...
      <div class="dir-art"><img src="/assets/site-img/img-05-10df6582b6.webp?v=<?= @filemtime(__DIR__ . '/assets/site-img/img-05-10df6582b6.webp') ?: time() ?>" alt="Mavka sautant de joie"></div>
    </div>
  </section>
</div>
...
<div class="page" id="page-activites">
  ...
  <section>
    <div class="wrap split">
      ...
      <div class="dir-art"><img src="/assets/site-img/img-07-b2cfcc755b.webp?v=<?= @filemtime(__DIR__ . '/assets/site-img/img-07-b2cfcc755b.webp') ?: time() ?>" alt="Mavka pointant vers le haut"></div>
    </div>
  </section>
</div>
...
<div class="page" id="page-intervenants">
  <section class="hero">
    <div class="wrap grid">
      ...
      <div class="hero-art"><img src="/assets/site-img/img-07-b2cfcc755b.webp?v=<?= @filemtime(__DIR__ . '/assets/site-img/img-07-b2cfcc755b.webp') ?: time() ?>" alt="Mavka pointant vers le haut, debout, main sur la hanche"></div>
    </div>
  </section>
...
<div class="page" id="page-collectivites">
    ...
    <div class="wrap grid">
      <div class="hero-copy">
        ...
        <div class="actions">
          ...
          <a class="btn btn-ghost" href="#parcours">Voir comment ça se passe</a>
        </div>
      </div>
      <div class="hero-art"><img src="/assets/site-img/img-04-3b8dc488ec.webp?v=<?= @filemtime(__DIR__ . '/assets/site-img/img-04-3b8dc488ec.webp') ?: time() ?>" alt="Mavka accroupie, une loupe à la main, observant une pousse"></div>
    </div>
  </section>
    ...
    <div class="wrap split">
      ...
      <div>
        ...
        <ul class="list">
          ...
          <li><span><b>Parcours et initiatives.</b> Un cadre pour partager ses savoir-faire, expérimenter une activité et, pour ceux qui le souhaitent, développer un projet associatif ou professionnel.</span></li>
        </ul>
      </div>
    </div>
  </section>

  <section id="parcours" class="sand">
    <div class="wrap">
      <div class="head">
        <span class="eyebrow">Le parcours de partenariat</span>
        <h2>Comment une collaboration avec MAVKA prend forme</h2>
        <p class="lede">Un parcours souple, construit ensemble selon les besoins de votre commune et les possibilités de chacun.</p>
      </div>
      <div class="steps cols-3">
        <div class="step">
          <h3>Première rencontre</h3>
          <ul class="list" style="margin-top:2px">
            <li><span>Présentation de MAVKA et de ses activités</span></li>
            <li><span>Écoute des priorités et des besoins de votre commune</span></li>
          </ul>
        </div>
        <div class="step">
          <h3>Co-construction</h3>
          <ul class="list" style="margin-top:2px">
            <li><span>Identifier ensemble les besoins des habitants et choisir une première action adaptée.</span></li>
            <li><span>Définir le rôle de chacun : MAVKA prépare l'activité ; la commune précise les moyens qu'elle peut mobiliser (lieu, information des habitants, appui logistique).</span></li>
          </ul>
        </div>
        <div class="step">
          <h3>Phase pilote</h3>
          <ul class="list" style="margin-top:2px">
            <li><span>Organiser un premier atelier ou événement test, en petit groupe et dans un format souple.</span></li>
            <li><span>Recueillir les retours des participants et faire un bilan commun avec la commune pour décider de la suite.</span></li>
          </ul>
        </div>
        <div class="step">
          <h3>Mise en place progressive</h3>
          <ul class="list" style="margin-top:2px">
            <li><span>Si le bilan est positif, définition ensemble des suites possibles : nouvel atelier, cycle ou événement ponctuel.</span></li>
            <li><span>Mobilisation des habitants et des intervenants</span></li>
          </ul>
        </div>
        <div class="step">
          <h3>Faire évoluer le partenariat</h3>
          <ul class="list" style="margin-top:2px">
            <li><span>Selon les besoins et les moyens disponibles, reconduire, adapter ou diversifier les actions.</span></li>
            <li><span>Ajuster la collaboration avec les habitants et les partenaires concernés.</span></li>
          </ul>
        </div>
        <div class="step">
          <h3>Faire le bilan et décider de la suite</h3>
          <ul class="list" style="margin-top:2px">
            <li><span>Évaluer ensemble les résultats obtenus</span></li>
            <li><span>Décider : clore la collaboration, reconduire l'action, ou construire un nouveau projet</span></li>
          </ul>
        </div>
      </div>
      <p class="parcours-visuel__note">Chaque collaboration avance à son rythme. Une action ponctuelle peut aussi être un projet réussi.</p>
    </div>
  </section>
  ...
  <section>
    <div class="wrap dir-grid">
      <div>
        <div class="head" style="margin-bottom:24px">
          <span class="eyebrow">Formats mobilisables</span>
          <h2>Des formats adaptés à votre commune, pas un modèle unique</h2>
        </div>
        <div class="dirs">
          <div class="dir">
            <div class="ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="5" width="17" height="15" rx="2.5"></rect><line x1="3.5" y1="9.5" x2="20.5" y2="9.5"></line><line x1="8" y1="3" x2="8" y2="7"></line><line x1="16" y1="3" x2="16" y2="7"></line></svg></div>
            <div><h3>Ateliers découverte</h3><p>Format court (1 à 2h), groupe réduit, sans engagement — pour tester l'intérêt du public.</p></div>
          </div>
          <div class="dir">
            <div class="ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v18"></path><path d="M5 8l7-5 7 5"></path><path d="M5 16l7 5 7-5"></path></svg></div>
            <div><h3>Cycles réguliers</h3><p>Plusieurs séances suivies, pour approfondir une pratique avec un même groupe.</p></div>
          </div>
          <div class="dir">
            <div class="ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s-7-4.4-7-10a4 4 0 0 1 7-2.6A4 4 0 0 1 19 11c0 5.6-7 10-7 10z"></path></svg></div>
            <div><h3>Événements festifs &amp; interculturels</h3><p>Fêtes de quartier, journées portes ouvertes, rencontres entre habitants.</p></div>
          </div>
          <div class="dir">
            <div class="ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19V7l8-4 8 4v12"></path><path d="M9 19v-6h6v6"></path></svg></div>
            <div><h3>Interventions scolaires &amp; périscolaires</h3><p>En lien avec les établissements, centres sociaux et structures jeunesse.</p></div>
          </div>
          <div class="dir">
            <div class="ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 8h16l-1.5 11a2 2 0 0 1-2 1.8H7.5a2 2 0 0 1-2-1.8z"></path><path d="M9 8V6a3 3 0 0 1 6 0v2"></path></svg></div>
            <div><h3>Stands &amp; permanences</h3><p>Présence sur les marchés, forums associatifs et forums des familles.</p></div>
          </div>
          <div class="dir">
            <div class="ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3"></circle><path d="M4 20c0-3.3 2.2-5.5 5-5.5s5 2.2 5 5.5"></path><circle cx="17" cy="8.5" r="2.4"></circle><path d="M14.8 14.8c2.2.3 3.7 2.1 3.7 5.2"></path></svg></div>
            <div><h3>Transmission entre habitants</h3><p>Un habitant partage un savoir-faire avec d'autres, dans un cadre accompagné par MAVKA.</p></div>
          </div>
        </div>
      </div>
      <div class="dir-art"><img src="/assets/site-img/img-06-3bc40d08fc.webp?v=<?= @filemtime(__DIR__ . '/assets/site-img/img-06-3bc40d08fc.webp') ?: time() ?>" alt="Mavka assise, en train de lire"></div>
  ...
  <section class="sand">
    <div class="wrap">
      <div class="head">
        <span class="eyebrow">Ce que nous voulons construire</span>
        <h2>Un territoire plus vivant</h2>
        <p class="lede">Des liens plus forts entre habitants, des savoir-faire mieux partagés, des projets qui durent parce qu'ils sont portés localement — voilà ce que nous cherchons à construire avec vous, pas à pas.</p>
      </div>
      <div class="pillars">
        <div class="pillar"><h3>Lien social et interculturel</h3><p>Des rencontres entre habitants d'origines, de générations et de parcours différents.</p></div>
        <div class="pillar"><h3>Apprentissage et transmission</h3><p>Les compétences déjà présentes sur le territoire sont reconnues et partagées.</p></div>
        <div class="pillar"><h3>Droit à l'erreur</h3><p>Chaque format peut être testé puis ajusté, sans pression de résultat immédiat.</p></div>
        <div class="pillar"><h3>Autonomie des habitants</h3><p>Voir les participants devenir progressivement acteurs, pas seulement spectateurs.</p></div>
        <div class="pillar"><h3>Solidarité et entraide</h3><p>Un cadre qui encourage l'écoute et le soutien entre participants.</p></div>
      </div>
    </div>
  </section>
  ...
  <section class="sand">
    <div class="wrap">
      <div class="cta-card">
        <h3>Parlons des besoins de votre commune.</h3>
        <p>Sans engagement, à votre rythme — une première rencontre suffit pour commencer à y voir clair.</p>
        <div class="actions">
          <a class="btn btn-primary" href="#contact">Organiser un premier échange →</a>
          <a class="btn btn-ghost" href="/assets/docs/projet-associatif.pdf" target="_blank" rel="noopener">Lire notre projet associatif</a>
        </div>
      </div>
    </div>
  </section>
